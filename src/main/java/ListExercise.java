...
public class ListExercise {
    ...
    public int get(List<Integer> list, int index){
        //.get() returs the elemnt, .indexOf() returns the index of the first occurrence of the element 
    ...
    public void removeFromList(List<Integer> list, int position){
        ...
        //I believe this would also be valid, but I think it's slightly redundant
